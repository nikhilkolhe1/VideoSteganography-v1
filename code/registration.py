...
labl_0 = tk.Label(window, text="Registration form for Video Steganography ",width=35,font=("Arial black", 40))  
labl_0.place(x=100,y=53)  


canvas=tk.Canvas(window,background="black",borderwidth=5)
canvas.place(x=350,y=140,width=800,height=600)  
